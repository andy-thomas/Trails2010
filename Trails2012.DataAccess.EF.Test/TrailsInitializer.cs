    ...
    public class TrailsInitializer : DropCreateDatabaseIfModelChanges<TrailsContext>
    {
        ...
        protected override void Seed(TrailsContext context)
        {
            ...
            var trails = new List<Trail>
                              {
                                  new Trail {Name = "Johnstone Canyon", Description = "Johnstone Canyon", Distance = 4.8M, ElevationGain = 200, EstimatedTime = 2, LocationId = 1, TrailType = trailTypes[0], DifficultyId = 1, ReturnOnEffort = 9.2M, OverallGrade = 7.2M, Notes="Good Waterfalls scenery. Good in all seasons. Take crampons in winter/spring", Longitude = -102, Latitude = 50},
